...
class SerialDriver final : public CommDriver {
 public:
   ...
   */
  ABSSCPI_API ErrorCode Open(const std::string& port);
   ...
   * on the bus
   */
  ABSSCPI_API void SetDeviceID(unsigned int id);
   ...
   */
  ABSSCPI_API unsigned int GetDeviceID() const;
